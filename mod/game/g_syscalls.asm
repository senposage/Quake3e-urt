...
; trap_PC_* aliases for c_players.c (same numbers as trap_BotLib* above)
equ	trap_PC_LoadSource			-579
equ	trap_PC_FreeSource			-580
equ	trap_PC_ReadToken			-581
equ	trap_PC_SourceFileAndLine			-582
