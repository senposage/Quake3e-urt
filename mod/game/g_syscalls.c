...
void trap_Auth_DropClient( int clientNum, const char *reason, const char *message ) {
	syscall( G_AUTH_DROP_CLIENT, clientNum, reason, message );
}
#endif
