...
#ifdef USE_AUTH
extern	vmCvar_t	authc;
extern	vmCvar_t	cl_auth;
extern	vmCvar_t	cl_auth_enable;
extern	vmCvar_t	cl_auth_login;
extern	vmCvar_t	cl_auth_notoriety;
extern	vmCvar_t	cl_auth_key;
extern	vmCvar_t	cl_auth_engine;
extern	vmCvar_t	cl_auth_status;
extern	vmCvar_t	cl_auth_time;
...
#define MAX_CROSSHAIRS		 20
#define MAX_CROSSHAIRS_TEXT  8192
...
typedef struct
{
	...
	int 		rectOffset; 						// rectangle offset
	const char	*name;								//
...
typedef struct
{
	...
	void (*ownerDrawItem)(float x, float y, float w, float h, float text_x, float text_y, int ownerDraw, int ownerDrawFlags, int ownerDrawParam, int ownerDrawParam2, int align, float special, float scale, vec4_t color, qhandle_t shader, int textStyle);
	float (*getValue)(int ownerDraw);
	qboolean (*ownerDrawVisible)(int flags);
	void (*runScript)(itemDef_t *, char * *p);
	...
	void (*getRectOffset)( int offsetid, rectDef_t *rect );
...
crosshair_t *		 utCrosshairGetAt ( int );
//27
